...
public struct BYUnderlineTextFieldSwiftUI: View {
    ...
    public init(text: Binding<String>, placeholder: String, alertText: String, validText: String, characters: [String], backColor: Color, textColor: Color, underLineColor: Color, leftIcon: String) {
        self._text = text
